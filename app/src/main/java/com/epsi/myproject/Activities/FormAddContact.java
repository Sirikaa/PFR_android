...
public class FormAddContact extends AppCompatActivity {
    ...
    private Spinner fonctionContact;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        idClient = (int) extras.getSerializable("idClient");
    ...
    private void initializeView(){
        ...
        addMaterielButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                new FormAddMateriel.HTTPAsyncTask().execute(URL);
            }
        });
    }
